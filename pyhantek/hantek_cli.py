#!/usr/bin/env python3
"""
CLI USB para Hantek 2xx2 (p. ej. 2D42; 2D72 con --pid 0x2d72) según ../dev_docs/pyhantek/PROTOCOLO_USB.md y HTHardDll descompilado.

Ejecutar desde este directorio (pyhantek/):
  python hantek_cli.py COMANDO ...
  python -m hantek_usb COMANDO ...
  python -m hantek_usb.cli COMANDO ...
Tras pip install / pipx: comando global ``hantek COMANDO ...``.
