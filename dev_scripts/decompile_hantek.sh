...
#
# Uso:
#   dev_scripts/decompile_hantek.sh
#   OUT_ROOT=/tmp/hantek_c dev_scripts/decompile_hantek.sh
#   LIMIT=1 dev_scripts/decompile_hantek.sh          # solo el primer archivo (prueba)
#   ANALYSIS_TIMEOUT=600 dev_scripts/decompile_hantek.sh
#
# Requisitos: dev_scripts/install_decompilador.sh (Ghidra + JDK)
