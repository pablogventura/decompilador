...
#
# Uso:
#   dev_scripts/decompile_ls_headless.sh
#   OUT_DIR=/ruta/salida dev_scripts/decompile_ls_headless.sh
#   BIN=/otro/ejecutable dev_scripts/decompile_ls_headless.sh
#
# Requisitos: dev_scripts/install_decompilador.sh (JDK + descarga de Ghidra en ghidra_*_PUBLIC/)
